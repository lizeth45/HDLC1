...
<body>
    <div class="container">
        <form class="row" method="POST" action="InsertUser.php">
            <div class="col-6">
                <label for="emailInput" class="form-label">Email</label>
                <input type="email" class="form-control" id="emailInput" name="correo" placeholder="Escribe tu email">
            </div>

            <div class="col-6">
                <label for="inputPass" class="form-label">Contraseña</label>
                <input type="password" class="form-control" id="inputPass" name="pass" placeholder="Escribe tu contraseña">
            </div>

            <div class="col-12">
                <label for="inputName" class="form-label">Nombre</label>
                <input type="text" class="form-control" id="inputName" name="nombre" placeholder="Escribe tu nombre completo">
            </div>

            <div class="col-4">
                <label for="inputPhone" class="form-label">Telefono</label>
                <input type="text" class="form-control" id="inputPhone" name="num_tel" placeholder="Escribe tu numero telefonico">
            </div>
            ...
            <div class="col-4">
                <input type="submit" class="btn btn-primary" href="InsertUser.php" value="GUARDAR">
            </div>
